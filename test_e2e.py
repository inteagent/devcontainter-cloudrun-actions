...
# This creates a secure application running on Cloud Run.
# This test builds and deploys the secure service for testing.
...
IMAGE_NAME = f"us-central1-docker.pkg.dev/{PROJECT}/YOUR-GCR-ARTIFACTS-REPO/{SERVICE}-{SUFFIX}"
